				...
				? availableWallets.length == 0
					...
					: availableWallets.map((wallet, i) => (
							<button
								...
								disabled={walletConnected || connecting || walletNameConnected == wallet.name}
								style={{
									fontWeight: walletNameConnected == wallet.name ? "bold" : "normal",
									margin: "8px",
									backgroundColor: walletNameConnected == wallet.name ? "green" : connecting ? "orange" : "grey",
								}}
							>
								<img
									src={wallet.icon}
